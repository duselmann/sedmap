...
//	}
	...
	/**
	 * Extracts the JNDI value as String-String key-value pairs in a java.util.Map
	 * 
	 * @param context
	 * @param fullContextName - the full name of the provided context
	 * @param useShortNames - true if the abbreviated lookup value is to be used as a key
	 * @param addTypeToValue - true if Object values of non-primitive type objects are to be prepended by a string indicating the class name
	 * @return 
	 */
