...
<body>
    <div id="singleSiteInfo" class="singleSiteInfo">
      ...
      <div class="siteDatum">
        <div class="siteInfoLabel">ID</div>                   <div class="siteInfoData" id="USGS_STATION_ID">08343234</div>
      </div>
      <div class="siteDatum">
        <div class="siteInfoLabel">Drainage Area</div>        <div class="siteInfoData" id="DRAINAGE_AREA_MI_SQ">2342</div>
      </div>
      <div class="siteDatum">
