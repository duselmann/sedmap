    ...
    <body onload="init()">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid" id="content-row">
                ...
                <%= AtomReaderUtil.getAtomFeedContentOnlyAsString("https://my.usgs.gov/confluence/createrssfeed.action?types=page&spaces=conf_all&title=SEDIMENT_QUICK&labelString=sediment_help_quick&excludedSpaceKeys=&sort=modified&maxResults=1&timeSpan=3650&showContent=true") %>
